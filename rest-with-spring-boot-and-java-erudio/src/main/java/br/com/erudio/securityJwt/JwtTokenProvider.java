...
public class JwtTokenProvider {
	...
	private long validetyInMiliseconds = 3600000;	
	...
	public TokenVO createAccessToken(String username, List<String> roles) {
		Date now = new Date();
		Date validity = new Date(now.getTime() + validetyInMiliseconds);
	...
	private String getRefreshToken(String username, List<String> roles, Date now) {
		Date validityRefreshToken = new Date(now.getTime() + (validetyInMiliseconds * 3));
		return JWT.create()
				.withClaim("roles", roles)
				.withIssuedAt(now)
	...
	public Authentication getAuthenticatication(String token) {
